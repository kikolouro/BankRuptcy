  ...
  <div id="wrapper">
    ...
    if ($bool) {
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
          ...
          <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin.php">
            <div class="sidebar-brand-icon rotate-n-15">
              <i class="fab fa-btc fa-spin fa-lg"></i>
            </div>
            <div class="sidebar-brand-text mx-3">BankRuptcy <sup></sup></div>
          </a>
          ...
          <div class="sidebar-heading">
            Manutencão das Tabelas
          </div>

          <!-- Nav Item - Pages Collapse Menu -->
          <li class="nav-item">
            <a class="nav-link" href="admin.php?cmd=utilizadores">
          ...
          <li class="nav-item">
            <a class="nav-link" href="admin.php?cmd=contas">
              <i class="	fa fa-address-card"></i>
              <span>Contas</span>
            </a>
          </li>
          ...
          <!-- Nav Item - Pages Collapse Menu -->
          <li class="nav-item">
            <a class="nav-link" href="admin.php?cmd=tiposdeconta">
              <i class="	fa fa-address-card"></i>
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                  ...
                  <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    <a class="dropdown-item" href="index.php?cmd=perfil&id=<?= $_SESSION['id'] ?>">
      ...
      switch ($cmd) {
        ...
        case "contas":
          require('admin_apis/contas.php');
          // echo '<script>alert(' . $cmd . ');</script>';
          break;
        case "home":
          require('admin_apis/home.php');
          // echo '<script>alert(' . $cmd . ');</script>';
          break;
        case "login":
          require('admin_apis/login.php');
          //echo '<script>alert("' . $cmd . '");</script>';
          break;
        case "loginDados":
          require('admin_apis/api-login.php');
          //echo '<script>alert("' . $cmd . '");</script>';
          break;
        case "logout":
          require('admin_apis/api-logout.php');
          //echo '<script>alert("' . $cmd . '");</script>';
          break;
        case "utilizadores":
          require('admin_apis/utilizadores.php');
          //echo '<script>alert("' . $cmd . '");</script>';
          break;
        case "utilizadoresadd":
          require('admin_apis/utilizadoresaddform.php');
          //echo '<script>alert("' . $cmd . '");</script>';
          break;
      }
      //echo '<script>alert("' . $cmd . '");</script>';
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="admin.php?cmd=logout">Logout</a>
              </div>
            </div>
          </div>
        </div>
