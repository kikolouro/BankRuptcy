...
try {
    if (isset($_REQUEST['id']))
        $id = $_REQUEST['id'];
    $stmt = $db->prepare('Select * from TipoUtilizador where idTipoUser = :id');
    ...
    <div class="col my-auto">
        <div class="container">
            <div class="jumbotron card kcardbg shadow-sm border-dark">
                <h1 class="text-light">Atualizar Tipo de Utilizador</h1>
                <form class="form-horizontal" action="index.php?cmd=AtualizarTipoUser&id=<?= $id ?>" method="post">
                    <div class="container">
